...
import rasm1 from "../assets/Bitmap (3).png";
import rasm2 from "../assets/Bitmap (4).png";
import rasm3 from "../assets/Bitmap (5).png";
  ...
  return (
    <>
      <Layout>
        {data && (
          <div>
            <div className="flex justify-center items-center max-w-[360px] w-full h-[100px]">
              <Link to="/">
                <h2 className="text-center">Go back</h2>
              </Link>
            </div>
            <div className=" flex   md:justify-center md:items-center mb-10">
              <div className="w-[300px]  md:w-[1110px]  flex flex-col xl:flex-row justify-between  items-center">
                <div className="  h-[352px] xl:w-[540px] xl:h-[560px] bg-slate-100 p-[0px] xl:p-[15px]  flex items-center justify-center">
                  <img src={head} alt="" />
                </div>
                ...
                <div className="flex justify-center items-center">
                  <div className="max-w-[1110px] flex flex-col items-center xl:flex-row gap-10 w-full">
                    <div className="w-[350px] h-[471px]">
                      <div className="w-[350px] h-[318] p-[60px] bg-slate-100 flex justify-center items-center">
