...
import rasm1 from "../assets/Bitmap (12).png";
import rasm2 from "../assets/Bitmap (13).png";
import rasm3 from "../assets/Bitmap (14).png";
import fast from "../assets/Group 3.png";
import fast1 from "../assets/fast.png";
import fast2 from "../assets/image-removebg-preview(49).png";
              ...
              <div className="w-[1110px] flex flex-col">
                ...
                <div className="flex justify-center items-center">
                  <div className="max-w-[1110px] flex flex-col items-center xl:flex-row gap-10 w-full">
                    ...
                    <div className="w-[350px] h-[471px]">
                      <div className="w-[350px] h-[318] p-[50px] bg-slate-100 flex justify-center items-center">
