...
import head from "../assets/ez.png";
import rasm1 from "../assets/Bitmap (15).png";
import rasm2 from "../assets/Bitmap (16).png";
import rasm3 from "../assets/Bitmap (17).png";
              ...
              <div className="w-[1110px] flex flex-col">
                ...
                <div className="flex justify-center items-center">
                  <div className="max-w-[1110px] flex flex-col items-center xl:flex-row gap-10 w-full">
                    ...
                    <div className="w-[350px] h-[471px]">
                      <div className="w-[350px] h-[318] p-[67px] bg-slate-100 flex justify-center items-center">
